...
export const heroBaustein = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Bild",
      type: "bildMitAlt",
      description: "Am besten ein PNG/WebP mit transparentem Himmel (Fahrzeug freigestellt, Boden bleibt): Dann steht der rote Titel hinter dem Auto. Ein normales Foto deckt den Titel zu.",
