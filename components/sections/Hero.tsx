  ...
  return (
    <section className="relative" aria-labelledby={`${b._key}-titel`}>
      <div className="mx-auto max-w-7xl px-0 sm:px-6">
        <div className="relative aspect-[16/10] overflow-hidden sm:aspect-[16/8] lg:aspect-[21/8] sm:rounded-lg">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="relative -mt-10 max-w-2xl rounded-lg bg-gradient-to-br from-blau to-blau-tief px-6 py-7 text-white shadow-[0_24px_48px_-24px_rgba(18,20,26,.6)] ring-1 ring-white/10 sm:-mt-20 sm:px-10 sm:py-10">
