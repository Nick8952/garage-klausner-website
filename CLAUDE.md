...
- **Schrift (Nicks Vorgabe 17.09.2026, «seriös»):** Inter Tight 800 für Titel/Hero-Schriftzug, Inter 400–700 für alles andere (Buttons, Kurzzeilen, Zahlen mit `tabular-nums`). Keine Display-/Mono-Experimente mehr. Nur via `next/font`.
- **Buttons:** rechteckig mit 4 px Radius (`rounded-[4px]`), Inter semibold, Rot gefüllt (primär) oder weiss mit grauer Kante (sekundär); keine Schatten, Glanzkanten oder Klick-Versatz.
